...
title: ExtraArithmeticAssertionsEnabled 函式
...
ms.locfileid: "98846658"
---
# <a name="extraarithmeticassertionsenabled-function"></a>ExtraArithmeticAssertionsEnabled 函式
...
若為 true，則會啟用高成本的額外判斷提示，但對於偵測算術函式的使用很有用。
