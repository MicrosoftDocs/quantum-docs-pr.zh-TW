...
### <a name="oracle--qubitqubit--unit-adj--ctl"></a>oracle： ([量子位](xref:microsoft.quantum.lang-ref.qubit)[]、[量子位](xref:microsoft.quantum.lang-ref.qubit)[] ) => [單位](xref:microsoft.quantum.lang-ref.unit) 形容詞 + Ctl
...
### <a name="allqubits--qubit"></a>allQubits： [量子位](xref:microsoft.quantum.lang-ref.qubit)[]
