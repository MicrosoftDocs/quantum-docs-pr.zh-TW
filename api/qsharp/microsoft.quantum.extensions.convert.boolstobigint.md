...
ms.locfileid: "98849935"
---
# <a name="boolstobigint-function"></a>BoolsToBigInt 函式
...
> [!WARNING]
> BoolsToBigInt 已被取代。 請改用 <xref:Microsoft.Quantum.Convert.BoolArrayAsBigInt>。
>
> 請使用 @"microsoft.quantum.convert.boolarrayasbigint"。
