...
ms.locfileid: "92697383"
---
# <a name="log-function"></a>Log 函數
...
> [!WARNING]
> 記錄檔已被取代。 請改用 <xref:Microsoft.Quantum.Math.Log>。
>
> 請使用 @"microsoft.quantum.math.log"。
...
### <a name="input--double"></a>輸入： [Double](xref:microsoft.quantum.lang-ref.double)
