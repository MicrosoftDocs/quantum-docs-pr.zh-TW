...
### <a name="statepreparation--qubit--unit-adj--ctl"></a>statePreparation： [量子位](xref:microsoft.quantum.lang-ref.qubit)[] => [單位](xref:microsoft.quantum.lang-ref.unit) 調整 + Ctl

單一的 $P $，可準備某個目標狀態。


### <a name="selector--qubitqubit--unit-adj--ctl"></a>選取器： ([量子位](xref:microsoft.quantum.lang-ref.qubit)[]、[量子位](xref:microsoft.quantum.lang-ref.qubit)[] ) => [單位](xref:microsoft.quantum.lang-ref.unit) 形容詞 + Ctl
