...
---
# <a name="_tojordanwignerselectinput_-function"></a>_ToJordanWignerSelectInput_ 函式
...
## <a name="output--qubitqubitqubitlittleendianlittleendian--unit-adj--ctl"></a>Output： ([量子位](xref:microsoft.quantum.lang-ref.qubit)，[量子位](xref:microsoft.quantum.lang-ref.qubit)[]，[量子位](xref:microsoft.quantum.lang-ref.qubit)[]，[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)，[LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian)[] ) => [單位](xref:microsoft.quantum.lang-ref.unit) 形容詞 + Ctl
