...
---
# <a name="_jordanwigneroptimizedblockencoding_-function"></a>_JordanWignerOptimizedBlockEncoding_ 函式
...
## <a name="output--intintdoubleblockencodingreflection"></a>輸出： ( # B1 [Int](xref:microsoft.quantum.lang-ref.int)，[Int](xref:microsoft.quantum.lang-ref.int)) ， ([Double](xref:microsoft.quantum.lang-ref.double)，[BlockEncodingReflection](xref:Microsoft.Quantum.Simulation.BlockEncodingReflection)) # A5
