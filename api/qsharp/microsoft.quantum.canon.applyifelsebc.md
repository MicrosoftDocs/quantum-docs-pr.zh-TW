...
### <a name="trueop--t--unit-ctl"></a>trueOp： t => [單位](xref:microsoft.quantum.lang-ref.unit) Ctl
...
### <a name="falseop--u--unit-ctl"></a>falseOp： ' U => [單位](xref:microsoft.quantum.lang-ref.unit) Ctl
