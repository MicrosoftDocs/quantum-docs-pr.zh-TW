...
> [!WARNING]
> ApplyReversedOpBigEndianA 已被取代。 請改用 <xref:Microsoft.Quantum.Arithmetic.ApplyReversedOpBEA>。
>
> 請使用 @"Microsoft.Quantum.Arithmetic.ApplyReversedOpBEA"。
