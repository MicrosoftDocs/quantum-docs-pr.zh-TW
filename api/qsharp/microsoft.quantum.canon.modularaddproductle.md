...
> [!WARNING]
> ModularAddProductLE 已被取代。 請改用 <xref:Microsoft.Quantum.Arithmetic.MultiplyAndAddByModularInteger>。
>
> 請使用 @"Microsoft.Quantum.Arithmetic.MultiplyAndAddByModularInteger"。
