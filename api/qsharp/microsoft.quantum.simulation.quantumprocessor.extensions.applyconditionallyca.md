...
### <a name="onequalop--t--unit--is-adj--ctl"></a>onEqualOp： t => [單位](xref:microsoft.quantum.lang-ref.unit)  為形容詞 + Ctl
...
### <a name="onnonequalop--u--unit--is-adj--ctl"></a>onNonEqualOp： ' U => [單位](xref:microsoft.quantum.lang-ref.unit)  為形容詞 + Ctl
