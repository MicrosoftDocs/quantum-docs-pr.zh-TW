...
ms.locfileid: "92697802"
---
# <a name="dumpregister-function"></a>DumpRegister 函式

命名空間： [Microsoft. 副檔名診斷](xref:Microsoft.Quantum.Extensions.Diagnostics)

包： [](https://nuget.org/packages/)


> [!WARNING]
> DumpRegister 已被取代。 請改用 <xref:Microsoft.Quantum.Diagnostics.DumpRegister>。
>
> 請使用 @"microsoft.quantum.diagnostics.dumpregister"。
