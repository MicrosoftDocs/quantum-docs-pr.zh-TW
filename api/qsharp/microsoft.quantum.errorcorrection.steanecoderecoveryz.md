...
---
# <a name="steanecoderecoveryz-function"></a>SteaneCodeRecoveryZ 函式
...
⟦7，1，3⟧ Steane 量副程式代碼中，Z 部分的的解碼器。
...
### <a name="syndrome--syndrome"></a>症狀： [症狀](xref:Microsoft.Quantum.ErrorCorrection.Syndrome)
