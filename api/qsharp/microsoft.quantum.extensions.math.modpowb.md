...
ms.locfileid: "92697350"
---
# <a name="modpowb-function"></a>ModPowB 函式

命名空間 [： ...](xref:Microsoft.Quantum.Extensions.Math)

包： [](https://nuget.org/packages/)


> [!WARNING]
> ModPowB 已被取代。 請改用 <xref:Microsoft.Quantum.Math.ModPowL>。
>
> 請使用 @"microsoft.quantum.math.modpowl"。
...
### <a name="exponent--bigint"></a>指數： [BigInt](xref:microsoft.quantum.lang-ref.bigint)
