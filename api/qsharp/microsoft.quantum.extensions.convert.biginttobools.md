...
ms.locfileid: "96213492"
---
# <a name="biginttobools-function"></a>BigIntToBools 函式
...
> [!WARNING]
> BigIntToBools 已被取代。 請改用 <xref:Microsoft.Quantum.Convert.BigIntAsBoolArray>。
>
> 請使用 @"microsoft.quantum.convert.bigintasboolarray"。
