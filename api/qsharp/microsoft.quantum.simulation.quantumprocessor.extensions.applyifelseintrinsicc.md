...
### <a name="onresultzeroop--unit--unit--is-ctl"></a>onResultZeroOp： [單位](xref:microsoft.quantum.lang-ref.unit) => [單位](xref:microsoft.quantum.lang-ref.unit)  是 Ctl




### <a name="onresultoneop--unit--unit--is-ctl"></a>onResultOneOp： [單位](xref:microsoft.quantum.lang-ref.unit) => [單位](xref:microsoft.quantum.lang-ref.unit)  是 Ctl
