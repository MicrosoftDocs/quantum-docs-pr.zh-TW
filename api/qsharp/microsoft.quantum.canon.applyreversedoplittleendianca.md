...
> [!WARNING]
> ApplyReversedOpLittleEndianCA 已被取代。 請改用 <xref:Microsoft.Quantum.Arithmetic.ApplyReversedOpLECA>。
>
> 請使用 @"Microsoft.Quantum.Arithmetic.ApplyReversedOpLEC"。
