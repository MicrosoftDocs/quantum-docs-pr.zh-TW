...
> [!WARNING]
> ModularMultiplyByConstantLE 已被取代。 請改用 <xref:Microsoft.Quantum.Arithmetic.MultiplyByModularInteger>。
>
> 請使用 @"Microsoft.Quantum.Arithmetic.MultiplyByModularInteger"。
