...
### <a name="onequalop--t--unit-adj"></a>onEqualOp： t => [單位](xref:microsoft.quantum.lang-ref.unit) 形容詞
...
### <a name="onnonequalop--u--unit-adj"></a>onNonEqualOp： ' U => [單位](xref:microsoft.quantum.lang-ref.unit) 形容詞
