...
### <a name="op--phaselittleendian--unit-adj--ctl"></a>op： [PhaseLittleEndian](xref:Microsoft.Quantum.Arithmetic.PhaseLittleEndian) => [單位](xref:microsoft.quantum.lang-ref.unit) 調整 + Ctl
