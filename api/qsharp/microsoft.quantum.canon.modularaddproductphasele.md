...
> [!WARNING]
> ModularAddProductPhaseLE 已被取代。 請改用 <xref:Microsoft.Quantum.Arithmetic.MultiplyAndAddPhaseByModularInteger>。
>
> 請使用 @"Microsoft.Quantum.Arithmetic.MultiplyAndAddPhaseByModularInteger"。
