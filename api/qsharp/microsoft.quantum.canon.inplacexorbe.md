...
> [!WARNING]
> InPlaceXorBE 已被取代。 請改用 <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)>。
>
> 已移除此作業。
...
### <a name="target--bigendian"></a>目標： [BigEndian](xref:Microsoft.Quantum.Arithmetic.BigEndian)
