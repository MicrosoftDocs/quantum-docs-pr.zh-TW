...
| [`%simulate`](xref:microsoft.quantum.iqsharp.magic-ref.simulate) | 在 QuantumSimulator 目標電腦上執行指定的函式或操作 |
| [`%toffoli`](xref:microsoft.quantum.iqsharp.magic-ref.toffoli) | 在 ToffoliSimulator 模擬器目標電腦上執行指定的函式或作業 |
| [`%who`](xref:microsoft.quantum.iqsharp.magic-ref.who) | 提供與目前工作區相關的動作。 |
| [`%workspace`](xref:microsoft.quantum.iqsharp.magic-ref.workspace) | 傳回目前工作階段中定義的所有作業和函式清單，不論是以互動方式或從目前工作區載入。 |
