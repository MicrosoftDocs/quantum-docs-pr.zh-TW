...
這個專案歡迎您提供貢獻和建議。
大部分的貢獻都要求您同意「參與者授權合約」（CLA），宣告您有權，並確實授與我們使用您的投稿的權利。 如需詳細資訊，請造訪[CLA](https://cla.microsoft.com)。

當您提交提取要求時，CLA bot 會自動判斷您是否需要提供 CLA 並適當地裝飾 PR （例如標籤、批註）。 只要遵循 bot 所提供的指示即可。 您只需要使用我們的 CLA 在所有存放庫上執行此動作一次。
