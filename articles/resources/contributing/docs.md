...
<span data-ttu-id="593e0-137">此命令會[ `Game.qs` 從 `chsh-game` 範例](https://github.com/microsoft/Quantum/blob/main/samples/algorithms/chsh-game/Game.qs)匯入檔案中的第4行到第8行，將它們標示為 Q# 程式碼以進行語法醒目提示。</span><span class="sxs-lookup"><span data-stu-id="593e0-137">This command will import lines 4 to 8 of the [`Game.qs` file from the `chsh-game` sample](https://github.com/microsoft/Quantum/blob/main/samples/algorithms/chsh-game/Game.qs), marking them as Q# code for the purpose of syntax highlighting.</span></span>
...
<span data-ttu-id="593e0-147">您可以透過 Q# 檔批註中的特殊命名 Markdown 區段，將這些不同的資訊片段提供給編譯器。</span><span class="sxs-lookup"><span data-stu-id="593e0-147">Each of these different pieces of information can be provided to the Q# compiler by a specially named Markdown section in the documentation comment.</span></span>
...
- <span data-ttu-id="593e0-151">每個檔批註的格式都必須符合 Q# 編譯器預期的檔顯示正確的內容。</span><span class="sxs-lookup"><span data-stu-id="593e0-151">The format of each documentation comment has to match what the Q# compiler expects for your documentation to appear correctly.</span></span> <span data-ttu-id="593e0-152">某些區段（例如 `/// # Remarks` 允許自由格式的內容），而區段（例如 `/// # See Also` 區段）的限制較嚴格。</span><span class="sxs-lookup"><span data-stu-id="593e0-152">Some sections, such as `/// # Remarks` allow for freeform content, while sections such as `/// # See Also` section are more restrictive.</span></span>
